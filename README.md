...
- **Pre-Alpha (Current State):** Will feature basic chatting between users. Does not include encryption or other advanced features. No compiled application is available yet.
- **Alpha:** Will introduce encryption, groups, and some other core features. Testing is conducted strictly among the developer's close associates. No public application is available yet.
- **Beta (Final Testing Stage):** Will include all planned features. This stage is dedicated to bug testing and the occasional addition of small improvements. Compiled applications will be available for Windows, macOS, and most Linux distributions.
- **Release:** All bugs fixed, all features fully implemented. Applications will be available on all previously supported desktop platforms, as well as Android and iOS.
